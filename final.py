...
def contact_page():
    image_path = "contact.png"  # Update this path as needed
...
def signup_page():
    ...
    bg_image_path = "C:/Users/Ardra/Documents/cts final/background_signup.png"  # Path to your uploaded image
    bg_image = Image.open(bg_image_path)
    bg_image_base64 = st_image_to_base64(bg_image)  # Converts image to base64
...
def display_login_as_page():
    ...
    set_bg_image('background_login.png')  # Replace with the path to your background image
...
def display_nurse_login():
    ...
    # Load images
    bg_image_path = "background_log.png"
        ...
        with col1:
            ...
            st.markdown(
                ...
                <div class="hover-container">
                    <img src="data:image/png;base64,{image_to_base64("admin.png")}" alt="Dashboard Image">
                    <p>Admin panel</p>
                </div>
                """,
                unsafe_allow_html=True
...
def display_admin_login():
    ...
    # Load images
    bg_image_path = "background_log.png"
    icon_image_path = "office assistant.png"
